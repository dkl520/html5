...
CREATE TABLE jd_order(
  ...
  addr VARCHAR(128),
  price FLOAT(12,2),
  payment INT,          #付款方式1/2/3/4
  orderTime BIGINT,
  status INT,           #订单状态1/2/3/4/5/6
  userId INT
);
INSERT INTO jd_order VALUES
(NULL,'强东妈','北京市海淀区','3565.00','1','1401234567890','3','10'),
(NULL,'强东爸','北京市海淀区','1565.00','2','1411234567890','4','10'),
(NULL,'强东弟','北京市海淀区','2865.00','3','1421234567890','5','10'),
(NULL,'强东哥','北京市海淀区','1165.00','4','1431234567890','6','10'),
(NULL,'强东姐','北京市海淀区','8965.00','1','1441234567890','2','10'),
(NULL,'强东妹','北京市海淀区','3365.00','2','1451234567890','1','10');
